import {isObj, Obj, ObjInvary} from "../src/invary/obj";
import {isObj as isObjDev, Obj as ObjDev, ObjInvary as ObjInvaryDev} from "../src/invary/obj_dev_mode";
...
test(isObj, Obj, ObjInvary);
test(isObjDev, ObjDev, ObjInvaryDev);
