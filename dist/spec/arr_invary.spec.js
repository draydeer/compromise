...
describe('ArrInvary', function () {
    it('should be created by factory from array then be instance of ArrInvary', function () {
        ...
        expect(arr instanceof src_1.ArrInvary).toBeTruthy();
        expect(arr instanceof Array).toBeTruthy();
        expect(arr instanceof Object).toBeTruthy();
    });
    it('should be constructed', function () {
        expect(new src_1.ArrInvary() instanceof src_1.ArrInvary).toBeTruthy();
        expect(new src_1.ArrInvary([1]) instanceof src_1.ArrInvary).toBeTruthy();
    });
